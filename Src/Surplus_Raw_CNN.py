...
df = pd.read_csv('../Data_Prediction/Soybean_Data.csv', index_col=0,
                    low_memory=False, chunksize=280989)
category_number = 17
...
for chunk in categories:
    ...
    print(chunk.shape)
    chunk.to_csv('../Data_Prediction/Raw_Chunk/'
                 'Soybean_X_Raw_{}'.format(chunk_num)
