...
compressed_fileList = natsorted(glob.glob("../ModelMetaData/Soybean_Net_2/Soybean_Net_2_EncData/"+"*.csv"))
#compressed_fileList = compressed_fileList[0:1200]  #change
...
for i in range(len(x)):
    ...
    encoder.summary()
    # plot_model(encoder, to_file='../ModelMetaData/Soybean_Net_3/Soybean_Net_3_FlowGraph/'
    #                                 'Soybean_Net_3_EncFlowGraph_{}'.format(index) + '.png', show_shapes=True)
    # plot_model(autoencoder, to_file='../ModelMetaData/Soybean_Net_3/Soybean_Net_3_FlowGraph/'
    #                                'Soybean_Net_3_FlowGraph_{}'.format(index) + '.png', show_shapes=True)
    ...
    np.savetxt('../ModelMetaData/Soybean_Net_3/Soybean_Net_3_EncData/Soybean_Net_3_EncData_{}'.format(index)
    ...
    np.savetxt('../ModelMetaData/Soybean_Net_3/Soybean_Net_3_DecData/Soybean_Net_3_DecData_{}'.format(index)
               + '.csv', dec_out, delimiter=",", fmt='%1.0f')
    # np.savetxt('Test/Analog_Output_fmt.csv', dec_out, delimiter=",", fmt='%1.0f')
    # save model
    filename = '../ModelMetaData/Soybean_Net_3/Soybean_Net_3_Model/Soybean_Net_3_Model_{}'.format(
        index) + '.h5'
    ...
    plt.savefig('../ModelMetaData/Soybean_Net_3/Soybean_Net_3_Plot/Soybean_Net_3_PlotLoss_{}'.format(index) + '.png')
    # plt.show()
    plt.clf()
    index += 1

#change
np.savetxt('../ModelMetaData/Soybean_Net_3/Soybean_Net_3_Evaluate/'
           'Soybean_Net_3_Evaluate_.csv', evaluate, delimiter=',',
           fmt='%1.3f', comments='', header='Loss')
np.savetxt('../ModelMetaData/Soybean_Net_3/Soybean_Net_3_MSE/'
           'Soybean_Net_3_MSE_.csv', mse_loss, delimiter=',',
           fmt='%1.5f', comments='', header='MSE Loss')

pathlib.Path("../ModelMetaData/Soybean_Net_3/Soybean_Net_3_Time/"
        "Soybean_Net_3_TrainingTime.txt")\
        .write_text("HDRA_Net_3_Training_Time: {}"
        .format(time.time() - start_time))
pathlib.Path("../ModelMetaData/Soybean_Net_3/Soybean_Net_3_MSE/"
        "Soybean_Net_3_MSE.txt").write_text("Soybean Net_3 Mean MSE Loss: {}"
